...
const BYTE LAYOUT_RIGHT[KeyMatrix::MAX_DIM][KeyMatrix::MAX_DIM] = {
...
const BYTE LAYOUT_LEFT[KeyMatrix::MAX_DIM][KeyMatrix::MAX_DIM] = {0};
const BYTE LAYOUT_NUM[KeyMatrix::MAX_DIM][KeyMatrix::MAX_DIM] = {0};
const BYTE LAYOUT_NAV[KeyMatrix::MAX_DIM][KeyMatrix::MAX_DIM] = {0};
